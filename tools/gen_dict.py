...
# help菜单
def usage():
    print ("python2 gen_dict.py -n li.ming -b 19941016 -p 13933893931 -q 385293936")
    print ("python2 gen_dict.py -n zhang.li -b 19950316 -p 13933893931 -d www.baidu.com")
    print ("python2 gen_dict.py -n zhang.li -b 19950316 -c 411081199002586541 -m a@gmail.com  -q qq123456 -i id123 -p 13933893931 -d www.baidu.com")
...
weak_password = [ "123456", "password", "12345678", "qwerty", "123456789",
